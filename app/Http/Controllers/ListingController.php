...
class ListingController extends Controller
{
    public function index($services_category_id){
        $services_category = ServicesCategory::with(['services', 'services.vehicle.images','services.serviceType'])->find($services_category_id);
    ...
    public function service_details($service_id, $service_name){
        $service = Service::with(['vehicle.images','serviceType','reviews'])->where('id', $service_id)->first();
